...
class _TweetDetailScreenState extends State<TweetDetailScreen> {
  ...
  void _loadTweetData() {
    final tweet = mockTweets[widget.tweetId];
    if (tweet != null) {
      mainTweet = tweet;
      replies = mainTweet.replyIds
  ...
  void _toggleLike() {
    setState(() {
      mainTweet.isLiked = !mainTweet.isLiked;
      mainTweet.likes += mainTweet.isLiked ? 1 : -1;
    });
  }

  void _toggleRetweet() {
    setState(() {
      mainTweet.isRetweeted = !mainTweet.isRetweeted;
      mainTweet.retweets += mainTweet.isRetweeted ? 1 : -1;
    });
  }

  @override
  Widget build(BuildContext context) {
    if (mockTweets[widget.tweetId] == null) {
