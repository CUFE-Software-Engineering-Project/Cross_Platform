...
// Privacy option enum matching API replyControl values
enum PostPrivacy {
  everyone, // API: "EVERYONE"
  following, // API: "FOLLOWING" (People you follow)
  mentioned; // API: "MENTIONED" (Only mentioned users)
  ...
  // Convert to API replyControl format
  String get apiValue {
    switch (this) {
      case PostPrivacy.everyone:
        return 'EVERYONE';
...
class _CreatePostScreenState extends ConsumerState<CreatePostScreen> {
  ...
  Future<void> _postTweet() async {
    ...
    try {
      // Call API with replyControl matching API specification
      await ref
          .read(homeViewModelProvider.notifier)
          .createPost(
            content: _textController.text.trim(),
            replyControl:
                _selectedPrivacy.apiValue, // EVERYONE, FOLLOWING, MENTIONED
