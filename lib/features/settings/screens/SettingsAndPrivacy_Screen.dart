...
//       appBar: AppBar(
//         leading: IconButton(
//           icon: const Icon(LucideIcons.arrowLeft, color: Palette.textWhite, size: 22),
//           onPressed: () => context.pop(),
//         ),
//         title: Column(
//           mainAxisSize: MainAxisSize.min,
//           children: const [
//             Text('Settings', style: TextStyle(color: Palette.textWhite, fontWeight: FontWeight.w700)),
//             SizedBox(height: 2),
...
//             children: [
//               Text('Settings', style: TextStyle(color: Palette.textWhite, fontWeight: FontWeight.w700, fontSize: 16)),
//               SizedBox(height: 2),
//               Text('@profilename', style: TextStyle(color: Palette.textSecondary, fontSize: 12)),
//             ],
//           )
...
//             SizedBox(width: 10),
//             Text('Search settings', style: TextStyle(color: Palette.textSecondary)),
//           ],
//         ),
//       ),
//     );
...
//   Widget _tile(Widget leadingWidget, String title, String subtitle, {VoidCallback? onTap}) => ListTile(
...
//           ),
//           _tile(
//             SvgPicture.asset('assets/icons/x.svg', width: 20, height: 20, color: Palette.textWhite),
//             'Premium',
//             'See what\'s included in Premium and manage your settings.',
//           ),
//           _tile(
//             SvgPicture.asset('assets/icons/money.svg', width: 20, height: 20, color: Palette.textWhite),
//             'Monetization',
...
//             onTap: () => GoRouter.of(context).pushNamed(RouteConstants.privacyandsafetyscreen, extra: null),
//           ),
//           _tile(
...
//           ),
//           _tile(
//             Icon(LucideIcons.moreHorizontal, color: Palette.textWhite, size: 22),
