...
class QuoteNotificationCard extends StatelessWidget {
  ...
  Widget _buildQuotedTweet() {
    final quotedProfileMediaId = notification.quotedProfileMediaId;
    final quotedUsername = notification.quotedUsername;
    ...
    final quoted = Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: Palette.textTertiary.withOpacity(1)),
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
    ...
    if (onOpenQuotedTweet == null) return quoted;

    return GestureDetector(
      behavior: HitTestBehavior.opaque,
      onTap: onOpenQuotedTweet,
      child: quoted,
    );
  }
}
